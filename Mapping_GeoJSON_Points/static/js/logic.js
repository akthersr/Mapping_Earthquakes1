...
let torontoData = "https://raw.githubusercontent.com/akthersr/Mapping_Earthquakes/main/torontoRoutes.json";
...
d3.json(torontoData).then(function(data) {
    ...
    L.geoJSON(data,{
        style:myStyle,
        onEachfeature:function(feature,layer) {
            layer.bindPopup("<h3> Airline:" + feature.properties.airlin + "</h3><hr><h3> Destination:"
